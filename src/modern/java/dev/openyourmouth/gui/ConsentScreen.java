...
public final class ConsentScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.centeredText(font, Component.translatable("gui.openyourmouth.consent.line1"), width / 2, height / 2 - 28, 0xFFD0D0D0);
        graphics.centeredText(font, Component.translatable("gui.openyourmouth.consent.line2"), width / 2, height / 2 - 14, 0xFFD0D0D0);
        graphics.centeredText(font, Component.translatable("gui.openyourmouth.consent.line3"), width / 2, height / 2, 0xFFFFC060);
    }
