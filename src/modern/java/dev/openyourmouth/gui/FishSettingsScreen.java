...
public final class FishSettingsScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.translatable("gui.openyourmouth.voice", selectedVoice(config)), ignored ->
                minecraft.gui.setScreen(new FishVoiceCatalogScreen(this))).bounds(left, y, 148, 20).build());
        y += 24;
    ...
    private void openModelSelector() {
        ...
        minecraft.gui.setScreen(new FishOptionSelectionScreen(this,
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        graphics.centeredText(font, catalogStatus(status), width / 2, 20,
