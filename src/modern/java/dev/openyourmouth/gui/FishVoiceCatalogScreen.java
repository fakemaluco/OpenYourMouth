...
public final class FishVoiceCatalogScreen extends Screen {
    ...
    protected void init() {
        ...
        addRenderableWidget(Button.builder(Component.translatable("gui.openyourmouth.fish.catalog.add_short"), ignored ->
                minecraft.gui.setScreen(new FishVoiceDetailsScreen(this, null))).bounds(x + 204, actionsY, 96, 20).build());
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        if (status.state() == TtsController.CatalogState.SYNCING) {
            graphics.text(font, Component.translatable("gui.openyourmouth.fish.catalog.syncing"), width / 2 + 154, 28, 0xFFFFD54F, false);
        }
    }
    ...
    private void openDetails() {
        VoiceEntry entry = voiceList.getSelected();
        if (entry != null) minecraft.gui.setScreen(new FishVoiceDetailsScreen(this, entry.voice));
    }
    ...
    private final class VoiceEntry extends ObjectSelectionList.Entry<VoiceEntry> {
        ...
        public void extractContent(GuiGraphicsExtractor graphics, int mouseX, int mouseY, boolean hovered, float delta) {
            ...
            graphics.text(font, Component.literal(shorten(voice.name, 42) + active), getContentX() + 4, getContentY() + 3, color, false);
            ...
            graphics.text(font, source, getContentX() + 4, getContentY() + 16, 0xFF909090, false);
        }
